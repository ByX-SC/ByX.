...
VisualsTab:CreateToggle({
    ...
    Callback = function(Value)
        ...
        if ESPEnabled then
            ...
            materialHighlights = {}
            for obj, adornments in pairs(boxAdornments) do for _, adornment in pairs(adornments) do adornment:Destroy() end end
            boxAdornments = {}
...
-- Color Picker for Line ESP (starts with team color, but can be custom)
VisualsTab:CreateColorPicker({
    Name = "Line ESP Color",
    Color = Color3.fromRGB(255, 255, 255),
    Callback = function(Value)
        espSettings.LineColor = Value
        -- Update existing lines to new color if not using team color
        for player, draws in pairs(drawings) do
            local teamColor = player.Team and player.Team.TeamColor.Color or Value
